 ...
 */
public interface IView2ModelAdapterCtrl<TDropListItem, PaintStraDropListItem> {

	/**
	 * The method that tells model the type name of the ball need to create
	 * @param fac strategy of the ball
	 */
	public void makeBall(TDropListItem fac, PaintStraDropListItem selectedPaintStra);

	/**
	 * @param fac strategy of the switch ball
	 */
	public void makeSwitchBall(TDropListItem fac, PaintStraDropListItem selectedPaintStra);
	 ...
	 */
	public static final IView2ModelAdapterCtrl<?, ?> NULL_OBJECT = new IView2ModelAdapterCtrl<Object, Object>() {
		//this is for make ball button
		public void makeBall(Object fac, Object paintStra) {

		}

		@Override
		public void makeSwitchBall(Object fac, Object paintStra) {
