...
public class BallWorldModel {
	...
	private Timer _timer = new Timer(_timeSlice, (e) -> _model2ViewAdpt.repaint());//action listener
	...
	public Ball make_ball(IStrategyFac selectedFactory) {
		...
		Ball newBall = new Ball(startLoc, startRadius, startVel, startColor, IUpdateStrategy.nullStrategy);
