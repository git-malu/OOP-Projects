...
public class BallModel {
	 ...
	 */
	public final SwitcherStrategy<IBallCmd> defaultStrategy = new SwitcherStrategy<>();
	...
	private Timer _timer2 = new Timer(_timeSlice, (e) -> {
	 ...
	 */
	public void loadBall(IUpdateStrategy<IBallCmd> strategy, IPaintStrategy paintStrat) {
...
//				strategy, paintStrat));
		_dispatcher.addObserver(new Ball(color, radius, location, velocity, _model2ViewGetCanvasAdpt.getCanvas(),
				strategy, paintStrat));
...
//		}); // The Graphics object is being given to all the balls (Observers)
	 ...
	 */
	public SwitcherStrategy<IBallCmd> getSwithcerStrategy() {
		return _switcher;
	}
