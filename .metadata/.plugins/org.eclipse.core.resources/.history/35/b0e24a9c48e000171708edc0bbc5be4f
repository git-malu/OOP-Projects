...
public class CreateTeamCmd extends DataPacketUserAlgoCmd<CreateTeamType>{
	...
	public CreateTeamCmd(IUserCmd2ModelAdapter cmd2ModelAdpt, Map<String, IChatRoom> teamsByName, Collection<IChatRoom> teams, Collection<IUser> users, IUser server) {
