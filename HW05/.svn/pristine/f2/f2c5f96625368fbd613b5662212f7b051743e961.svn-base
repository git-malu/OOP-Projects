...
/**
 * Paint strategy that paints a open-mouth fish-shaped Polygon.
 * 
...
public class Fish1PaintStrategy extends ShapePaintStrategy {
	...
	private static Point pt1 = new Point(-15, 10);
	...
	private static Point pt12 = new Point(11, 0);
	...
	private static Point pt23 = new Point(-15, -10);
	 ...
	 * @param width 
	 * 		The x-dimension of the fish
	 * @param height 
	 * 		The y-dimension of the fish
	 */
