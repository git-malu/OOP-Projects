...
import model.strategies.IInteractionStrategy;
...
public class Ball implements IObserver<IBallCmd> {
	...
	private IInteractionStrategy interactStrat = new IInteractionStrategy() {
	 ...
	 * 			  the paint strategy
	 */
	public Ball(Color color, int radius, Point startLoc, Point vel, Component Canvas,
			IUpdateStrategy<IBallCmd> strategy, IPaintStrategy paintStrat) {
		this.color = color;
		this.radius = radius;
	...
	public void interactWith(Ball target, IDispatcher<IBallCmd> dispatcher) {
		// TODO Auto-generated method stub
		interactStrat.interact(this, target, dispatcher);
		target.getInteractStrat().interact(target, this, dispatcher);
	}

	/**
	 * @return the interactStrat
	 */
	public IInteractionStrategy getInteractStrat() {
		return interactStrat;
	}

	/**
	 * @param interactStrat the interactStrat to set
	 */
	public void setInteractStrat(IInteractionStrategy interactStrat) {
		this.interactStrat = interactStrat;
	}
