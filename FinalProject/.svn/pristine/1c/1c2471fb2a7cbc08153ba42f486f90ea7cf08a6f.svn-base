...
class Player {
	 ...
	 * true means north team and false means south team
	 */
...
/**
 * Ball status and interactions in the game
 * @author malu
 *
 */
class Ball {
	/**
	 * ball marker on the map
	 */
	Marker ballMarker = new BasicMarker(Position.fromDegrees(0, 180, 4000), markerAttrs[10]);
	
	/**
	 * ball moving destination
	 */
	Position destination = Position.fromDegrees(0, 180, 0);
	
	/**
	 * ball marker needs to be converted to a list in order to display on the marker layer
	 */
	ArrayList<Marker> markers = new ArrayList<Marker>();
	
	/**
	 * ball status
	 * 0 static; 1 carried; 2 flying
	 */
